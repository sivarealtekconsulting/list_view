...
describe.skipIf(!sridharJobsValid)('ListView component contract', () => {
...
describe.skipIf(!sridharJobsValid)('ListView toolbar and table', () => {
...
describe('ListView JSON data props', () => {
...
describe('ListView API response validation', () => {
